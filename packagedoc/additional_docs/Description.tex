...
Details about the installation and the prerequisites can be found in the
\href{https://github.com/test-fullautomation/robotframework-qconnect-winapp/blob/develop/README.rst}{README}.
